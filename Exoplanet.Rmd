...
KOI_table.wo_incertitudes.log <- KOI_table_log %>% dplyr::select(-all_of(column_incertitudes))
KOI_table.wo_incertitudes.capped <- KOI_table_capped %>% dplyr::select(-all_of(column_incertitudes))
