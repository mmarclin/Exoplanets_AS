...
- remove NA
- fill the NA with specific value : mean, mice, etc...
...
- it can draw boundaries too close to the minority class (Log Reg, SVM)
```{r}
...
```
In our case, we can see imbalance between classes that we can handle with for example : 
